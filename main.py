...
if __name__ == "__main__":
    ...
    parser.add_argument('--gpu_num', type=int, default=1) # I have changed this from 0 to 1, to use the GPU 1
    
    # model setting

    parser.add_argument("--llm", type=str, default='mistral', help='flan_t5, opt, vicuna') # Choice of LLM Model
    ...
    parser.add_argument('--batch_size2', default=1, type=int)  # Original Batch Size 2
