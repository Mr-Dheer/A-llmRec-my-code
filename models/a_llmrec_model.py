    ...
    def generate(self, data):
        ...
        for i in range(len(text_input)):
           # Change the location here for the recommendation_output.txt, also create a new file
            f = open(f'/home/kavach/Dev/Publication/A-LLM-Rec/A-LLMRec_copy_original/rec_output/luxuryBeauty/recommendation_output_20_deepseek-base.txt','a') # Need to change this for the output
